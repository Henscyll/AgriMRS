...
<div class="main-content">
    ...
    <div class="page-header">
        ...
        <button class="btn btn-primary" onclick="openAddLotModal()">
            <span>+</span> Add New Lot
        </button>
    </div>
                ...
                <?php foreach ($lots as $lot): ?>
                    <div class="lot-card">
                        ...
                        <div class="lot-actions">
                            <button class="lot-btn btn-edit" onclick="editLot(<?= htmlspecialchars(json_encode($lot)) ?>)">
                                <span>✎</span> Edit
                            </button>
                            <button class="lot-btn btn-toggle" onclick="toggleLotStatus(<?= $lot['id'] ?>, '<?= $lot['status'] ?>')">
                                <span><?= $lot['status'] === 'Active' ? '⏸' : '▶' ?></span>
                                <?= $lot['status'] === 'Active' ? 'Deactivate' : 'Activate' ?>
                            </button>
                            <button class="lot-btn btn-delete" onclick="deleteLot(<?= $lot['id'] ?>)">
                                <span>🗑️</span> Delete
                            </button>
                        </div>
                    </div>
