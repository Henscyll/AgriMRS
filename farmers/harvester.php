...
<div class="page-content">
    ...
    <div class="page-header">
        <h2><i class="fas fa-tractor"></i> Available Harvesters</h2>
    </div>
    ...
    <div class="tractor-grid">
        ...
        <?php else: ?>
            <div class="empty-state">
                ...
                <p>No active harvesters match your search.</p>
            </div>
        <?php endif; ?>
    </div>
