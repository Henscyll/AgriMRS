...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST['record_payment'])) {
    ...
    /* Payment date now comes from the form (defaults to today, capped at today) */
...
<style>
    ...
    * { box-sizing: border-box; }
    body { font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; color: #000000; margin: 0; }
    ...
    .search-bar button  { background-color: #2d7a2d; color: #000000; border: none; cursor: pointer;
    ...
    .search-bar .flatpickr-input {
        ...
        border-radius: 6px !important; background: #fff !important; color: #000000 !important;
    ...
    .message { padding: 12px 18px; border-radius: 8px; margin-bottom: 12px;
               ...
               background: #d1fae5; color: #000000; border-left: 4px solid #10b981; font-size: 14px; }
    .message.error { background: #fee2e2; color: #000000; border-left-color: #ef4444; }
    ...
    .table-scroll tbody  { display: block; max-height: 260px; overflow-y: auto; overflow-x: hidden; width: 100%; }
    ...
    thead th {
        color: #000000; text-align: center; padding: 10px 4px; font-weight: 700;
        text-transform: uppercase; font-size: 10.5px; letter-spacing: 0.3px;
        white-space: normal; word-break: break-word; line-height: 1.35;
        vertical-align: middle; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;
    }
    ...
    tbody td {
        padding: 8px 5px; color: #000000; vertical-align: middle; font-size: 11px;
    ...
    thead th:nth-child(2),  tbody td:nth-child(2)  { width: 7%;  }  /* Reservation Date */
    thead th:nth-child(3),  tbody td:nth-child(3)  { width: 7%;  }  /* Farmer Name */
    thead th:nth-child(4),  tbody td:nth-child(4)  { width: 8%;  }  /* Farmer Address */
    thead th:nth-child(5),  tbody td:nth-child(5)  { width: 6%;  }  /* Phone */
    thead th:nth-child(6),  tbody td:nth-child(6)  { width: 8%;  }  /* Farm Location */
    thead th:nth-child(7),  tbody td:nth-child(7)  { width: 5%;  }  /* Farm Lot */
    thead th:nth-child(8),  tbody td:nth-child(8)  { width: 5%;  }  /* Farm Size */
    thead th:nth-child(9),  tbody td:nth-child(9)  { width: 6%;  }  /* Machine Type */
    thead th:nth-child(10), tbody td:nth-child(10) { width: 7%;  }  /* Machine Name */
    thead th:nth-child(11), tbody td:nth-child(11) { width: 7%;  }  /* Total Amount */
    thead th:nth-child(12), tbody td:nth-child(12) { width: 6%;  }  /* Paid */
    thead th:nth-child(13), tbody td:nth-child(13) { width: 6%;  }  /* Balance */
    thead th:nth-child(14), tbody td:nth-child(14) { width: 6%;  }  /* Due Date */
    thead th:nth-child(15), tbody td:nth-child(15) { width: 6%;  }  /* Schedule */
    thead th:nth-child(16), tbody td:nth-child(16) { width: 7%;  }  /* Status */

    .fw600 { font-weight: 600; }
    .fw700 { font-weight: 700; }

    .clr-green, .clr-red, .clr-muted { color: #000000 !important; }

    .no-data { text-align: center; padding: 60px 20px; color: #000000; }
    ...
    .badge-inactive { background: #fee2e2; color: #000000; padding: 2px 5px;
                      border-radius: 4px; font-size: 9px; font-weight: 700; margin-left: 3px; }
    ...
    .action-buttons a {
        ...
        background-color: #2d7a2d; color: #000000; cursor: pointer;
        font-size: 14px; font-weight: 600; transition: background 0.2s, transform 0.2s;
        display: inline-flex; align-items: center; gap: 8px; text-decoration: none;
    }
    .action-buttons button:hover,
    .action-buttons a:hover { background-color: #1a5c1a; transform: scale(1.03); }
    .action-buttons button:disabled {  cursor: not-allowed; transform: none; }
    ...
    .modal-box {
        background: white; width: 560px; max-width: 96%;
    ...
    .modal-head h3 { color: #000000; font-size: 18px; font-weight: 700; margin: 0; }
    .modal-head p  { color: #000000; font-size: 12px; margin: 4px 0 0; }
    .modal-x {
        width: 32px; height: 32px; background: rgba(255,255,255,0.2);
        border: none; border-radius: 50%; color: #000000; font-size: 18px;
    ...
    .ibox-label { font-size: 10px; font-weight: 700; color: #000000;
                  text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 3px; }
    .ibox-value { font-size: 13px; font-weight: 600; color: #000000; line-height: 1.35; }
    .ibox-sub   { font-size: 11px; font-weight: 500; color: #000000; margin-top: 2px; }
    .ibox-total   { background: #f0fdf4; border-radius: 8px; padding: 10px 13px; border: 1px solid #bbf7d0; }
    .ibox-balance { background: #fff5f5; border-radius: 8px; padding: 10px 13px; border: 1px solid #fecaca; }
    .ibox-total .ibox-label,
    .ibox-balance .ibox-label { font-size: 10px; font-weight: 700; color: #000000;
                                  text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 3px; }

    .or-display {
        background: #f8fafc; border: 1.5px dashed #2d7a2d; border-radius: 8px;
        padding: 12px 16px; margin-bottom: 16px;
        display: flex; align-items: center; gap: 10px;
    }
    .or-display i { color: #000000; font-size: 20px; flex-shrink: 0; }
    .or-display .or-label { font-size: 10px; font-weight: 700; color: #000000;
                            text-transform: uppercase; letter-spacing: 0.5px; }
    .or-display .or-number { font-size: 14px; font-weight: 700; color: #000000;
                             letter-spacing: 0.5px; font-family: 'Courier New', monospace; }
    .or-display .or-note { font-size: 10px; color: #000000; margin-top: 1px; }

    .date-display {
        background: #f0fdf4; border-radius: 8px; padding: 9px 14px;
        border: 1px solid #bbf7d0; display: flex; align-items: center; gap: 8px;
    }
    .date-display i { color: #000000; font-size: 15px; }
    .date-display span { font-size: 14px; font-weight: 600; color: #000000; }
    ...
    .m-row.full { grid-template-columns: 1fr; }
    .m-grp { display: flex; flex-direction: column; gap: 5px; }
    .m-grp label { font-size: 13px; font-weight: 600; color: #000000; }
    .m-grp label .req { color: #000000; }
    .m-wrap { position: relative; }
    .m-wrap .m-ico { position: absolute; left: 11px; top: 50%; transform: translateY(-50%);
                     color: #000000; font-size: 13px; pointer-events: none; }
    .m-wrap.ta-wrap .m-ico { top: 13px; transform: none; }
    .m-grp input, .m-grp textarea {
        width: 100%; padding: 9px 12px 9px 34px;
        border: 2px solid #e5e7eb; border-radius: 7px;
        font-size: 14px; font-family: inherit; color: #000000;
        transition: border-color .2s; background: white; box-sizing: border-box;
    }
    .m-grp input:focus, .m-grp textarea:focus {
        outline: none; border-color: #2d7a2d; box-shadow: 0 0 0 3px rgba(45,122,45,.1);
    }
    .m-hr { border: none; border-top: 2px solid #f0f0f0; margin: 14px 0; }
    .m-foot {
        padding: 14px 24px; background: #f9fafb; border-top: 1px solid #e5e7eb;
        display: flex; gap: 10px; justify-content: flex-end;
        border-radius: 0 0 14px 14px;
    }
    .m-cancel { padding: 9px 20px; background: white; color: #000000;
                border: 2px solid #e5e7eb; border-radius: 6px;
                font-size: 14px; font-weight: 600; cursor: pointer; }
    .m-cancel:hover { background: #f9fafb; }
    .m-submit { padding: 9px 22px; background: #2d7a2d; color: #000000;
                border: none; border-radius: 6px; font-size: 14px; font-weight: 600;
                cursor: pointer; display: flex; align-items: center; gap: 6px; }
    .m-submit:hover { background: #256725; }

    /* ══ HISTORY MODAL ══ */
    #historyModal .modal-box { width: 820px; max-width: 96%; }
    ...
    .hist-tx-list { display: flex; flex-direction: column; gap: 12px; margin-top: 12px; }
    .hist-tx-card {
        border: 1px solid #e5e7eb; border-radius: 10px;
        background: #fafafa; overflow: hidden;
    }
    .hist-tx-card:hover { box-shadow: 0 2px 10px rgba(0,0,0,.07); }
    .hist-tx-top {
        display: flex; justify-content: space-between; align-items: flex-start;
    ...
    .hist-tx-amt-block .amt-tag {
        font-size: 10px; color: #000000; font-weight: 600;
        text-transform: uppercase; letter-spacing: 0.5px; text-align: right; margin-bottom: 2px;
    }
    .hist-tx-amt-block .amt-val {
        font-size: 22px; font-weight: 800; color: #000000; text-align: right;
    }
    .hist-tx-body {
    ...
    .hist-tx-field {
        padding: 10px 16px; border-right: 1px solid #e5e7eb;
        border-bottom: 1px solid #e5e7eb;
    }
    .hist-tx-field:last-child { border-right: none; }
    .hist-tx-field.full-width { grid-column: 1 / -1; border-right: none; }
    .hist-tx-field .lbl { font-size: 10px; color: #000000; font-weight: 700;
                          text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 3px; }
    .hist-tx-field .val { font-size: 13px; color: #000000; font-weight: 600; }

    .hist-no-tx { text-align: center; padding: 40px 20px; color: #000000; font-size: 15px; }
    .hist-no-tx i { font-size: 36px; display: block; margin-bottom: 10px; color: #d1d5db; }

    .hist-tx-count-badge {
        font-size: 12px; font-weight: 700;
        background: #e9f5e9; color: #000000;
        padding: 3px 10px; border-radius: 12px; margin-left: 8px;
    }
    .overdue-pill {
        background: #fee2e2; color: #000000;
        padding: 4px 12px; border-radius: 999px; font-size: 11px; font-weight: 700;
        text-transform: uppercase; letter-spacing: .5px; display: inline-flex; align-items: center; gap: 4px;
    }

    /* ── Print ── */
    #printArea, #receiptPrintArea { display: none; }
    @media print {
        body > *:not(.print-active) { display: none !important; }
        .print-active { display: block !important; padding: 24px 32px; }
        ...
        #printArea thead th { background: #16a34a !important; color: #000000 !important; padding: 8px 5px;
                              -webkit-print-color-adjust: exact; print-color-adjust: exact; }
        #printArea tbody td { padding: 6px 5px; border-bottom: 1px solid #d1d5db; }

        #receiptPrintArea { padding: 0; }
        #receiptPrintArea .receipt-paper { width: 380px; margin: 0 auto; }
    }
    ...
    .receipt-head {
        background: linear-gradient(135deg, #16a34a, #15803d);
        color: #000000; text-align: center; padding: 22px 20px 18px;
    }
    ...
    .receipt-head h3 { margin: 0; font-size: 18px; font-weight: 800; }
    .receipt-head p  { margin: 4px 0 0; font-size: 12px; color: #000000; }
    .receipt-or {
        text-align: center; padding: 14px 20px; border-bottom: 1px dashed #d1d5db;
        background: #f8fafc;
    }
    .receipt-or .lbl { font-size: 10px; font-weight: 700; color: #000000;
                        text-transform: uppercase; letter-spacing: 0.5px; }
    .receipt-or .val { font-size: 16px; font-weight: 800; color: #000000;
                        font-family: 'Courier New', monospace; letter-spacing: 0.5px; margin-top: 2px; }
    ...
    .receipt-row .rk { color: #000000; font-weight: 600; }
    .receipt-row .rv { color: #000000; font-weight: 700; text-align: right; }
    .receipt-amount-box {
        background: #f0fdf4; border: 1px solid #bbf7d0; border-radius: 8px;
        padding: 14px 16px; margin: 12px 0; text-align: center;
    }
    .receipt-amount-box .lbl { font-size: 10px; font-weight: 700; color: #000000;
                                text-transform: uppercase; letter-spacing: 0.5px; }
    .receipt-amount-box .val { font-size: 26px; font-weight: 800; color: #000000; margin-top: 2px; }
    .receipt-balance-box {
        background: #fff5f5; border: 1px solid #fecaca; border-radius: 8px;
        padding: 10px 16px; margin-bottom: 4px; display: flex; justify-content: space-between; align-items: center;
    }
    .receipt-balance-box.paid { background: #f0fdf4; border-color: #bbf7d0; }
    .receipt-balance-box .lbl { font-size: 11px; font-weight: 700; color: #000000; text-transform: uppercase; }
    .receipt-balance-box .val { font-size: 15px; font-weight: 800; color: #000000; }
    .receipt-balance-box.paid .val { color: #000000; }
    .receipt-foot {
        text-align: center; padding: 12px 20px 18px; font-size: 10.5px; color: #000000;
        border-top: 1px solid #f0f0f0;
    }

    /* ══ CONFIRM DIALOG ══ */
    .confirm-box { width: 380px; max-width: 92%; }
    .confirm-body { padding: 26px 24px 8px; text-align: center; }
    .confirm-icon {
        width: 54px; height: 54px; border-radius: 50%; background: #fee2e2;
        display: flex; align-items: center; justify-content: center;
        margin: 0 auto 14px; font-size: 24px; color: #000000;
    }
    .confirm-icon.ok { background: #dcfce7; }
    .confirm-title { font-size: 16px; font-weight: 700; color: #000000; margin: 0 0 6px; }
    .confirm-text { font-size: 13px; color: #000000; margin: 0 0 6px; line-height: 1.4; }
    .confirm-foot {
        padding: 16px 24px 22px; display: flex; gap: 10px; justify-content: center;
    }
    .confirm-yes {
        padding: 9px 26px; background: #2d7a2d; color: #000000; border: none;
        border-radius: 6px; font-size: 14px; font-weight: 600; cursor: pointer;
    }
    .confirm-yes:hover { background: #256725; }
    .confirm-no {
        padding: 9px 26px; background: white; color: #000000; border: 2px solid #e5e7eb;
        border-radius: 6px; font-size: 14px; font-weight: 600; cursor: pointer;
    }
...
<div id="printArea">
    ...
    <table>
        <thead>
            <tr>
                <th>#</th><th>Reservation Date</th><th>Farmer Name</th><th>Farmer Address</th><th>Contact No.</th>
                <th>Farm Location</th><th>Farm Lot</th><th>Farm Size</th>
                <th>Machine Type</th><th>Machine Name</th>
                <th>Total Amount</th><th>Paid</th><th>Balance</th>
                <th>Due Date</th><th>Schedule</th><th>Status</th>
            </tr>
        </thead>
    ...
    <div class="table-container">
        <div class="table-scroll">
            <table>
                ...
                <?php endforeach; else: ?>
                <tr><td colspan="16" class="no-data">
                    <i class="fas fa-inbox"></i><p>No records found</p>
                </td></tr>
                <?php endif; ?>
                </tbody>
            </table>
...
<!-- ══════════════════════════════════
     PAYMENT MODAL (simplified — Collect Payment)
══════════════════════════════════ -->
<div class="modal-overlay" id="paymentModal">
  <div class="modal-box" style="width:460px;">
    <div class="modal-head">
      ...
      <button class="modal-x" onclick="closePaymentModal()"><i class="fas fa-times"></i></button>
    </div>
    <div class="modal-bd">
      ...
      <div style="display:grid; grid-template-columns:1fr 1fr; gap:8px; margin-bottom:8px;">
        <div class="ibox">
          ...
          <div style="font-size:16px; font-weight:800; color:#000000; margin-top:2px;" id="pay-total">—</div>
        </div>
        <div class="ibox-total">
          <div class="ibox-label">Already Paid</div>
          <div style="font-size:16px; font-weight:800; color:#000000; margin-top:2px;" id="pay-paid">—</div>
        </div>
      </div>

      <div class="ibox-balance" style="margin-bottom:16px;">
        <div class="ibox-label">Remaining Balance</div>
        <div style="font-size:18px; font-weight:800; color:#000000; margin-top:2px;" id="pay-balance">—</div>
      </div>
      ...
      <form method="POST" id="paymentForm" onsubmit="return false;">
        ...
        <div class="m-row full" style="margin-bottom:14px;">
          <div class="m-grp">
            <label>Amount to Collect <span class="req">*</span></label>
            <div class="m-wrap">
              <i class="fas fa-peso-sign m-ico"></i>
              <input type="number" name="amount" id="pay-amount"
        ...
        <div class="m-row full">
          <div class="m-grp">
            <label>Payment Date <span class="req">*</span></label>
            <div class="m-wrap">
              <i class="fas fa-calendar-day m-ico"></i>
    ...
    <div style="padding:0;">
      <div class="receipt-paper" style="border:none; border-radius:14px 14px 0 0;">
        <div class="receipt-head" style="border-radius:14px 14px 0 0; position:relative;">
          <button class="modal-x" onclick="closeReceiptModal()" style="position:absolute; top:14px; right:14px;">
...
<div class="modal-overlay" id="historyModal">
  <div class="modal-box">
    <div class="modal-head">
      ...
      <button class="modal-x" onclick="closeHistoryModal()"><i class="fas fa-times"></i></button>
    </div>
    <div class="modal-bd">
    ...
    if (field === 'reservation_date') {
        ...
        setTimeout(() => {
            fpFrom = flatpickr('#filterFrom', { dateFormat:'m/d/Y', allowInput:false,
                onChange: d => { document.getElementById('date_from').value = d.length ? fmt_ymd(d[0]) : ''; } });
            fpTo   = flatpickr('#filterTo', { dateFormat:'m/d/Y', allowInput:false,
                onChange: d => { document.getElementById('date_to').value = d.length ? fmt_ymd(d[0]) : ''; } });
        }, 0);
    }
    if (field === 'All') {
...
function openPaymentModal() {
    ...
    if (selectedLedger.status === 'Paid') { alert('This account is already fully paid.'); return; }
    ...
    document.getElementById('pay-date').max   = today; // no future-dated payments
...
function openHistoryModal(ledger) {
    ...
    const statusMap = { 'Paid':'badge-Paid','Unpaid':'badge-Unpaid','Partial':'badge-Partial','Overdue':'badge-Overdue' };
