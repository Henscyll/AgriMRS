...
<body>
  ...
  <header class="header">
    ...
    <div class="header-bottom">
      <nav>
        <a href="<?= $base_url ?>da_farmers.php" class="<?= in_array($current_page, ['da_farmers.php', 'da_farmers_profile.php']) ? 'active' : '' ?>">Farmers</a>
        <a href="<?= $base_url ?>da_reservations.php" class="<?= $current_page === 'da_reservations.php' ? 'active' : '' ?>">Reservation</a>
        <a href="<?= $base_url ?>da_machines.php" class="<?= in_array($current_page, ['da_machines.php', 'da_machine_profile.php']) ? 'active' : '' ?>">Machines</a>
        <a href="<?= $base_url ?>da_association.php" class="<?= in_array($current_page, ['da_association.php', 'da_association_profile.php']) ? 'active' : '' ?>">Associations</a>
        <a href="<?= $base_url ?>da_aboutus.php" class="<?= $current_page === 'da_aboutus.php' ? 'active' : '' ?>">About Us</a>
        <a href="<?= $base_url ?>da_contactus.php" class="<?= $current_page === 'da_contactus.php' ? 'active' : '' ?>">Contact Us</a>
